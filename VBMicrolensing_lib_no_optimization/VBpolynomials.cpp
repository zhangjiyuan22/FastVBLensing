...
// these two functions lack for __restrict
// leading to unnecessary memory access?
void VBMicrolensing::polyproduct(complex * p1, int n1, complex * p2, int n2, complex * pdest) {
	// polynomials are with increasing degree: p1[0] + p1[1]*z + p1[2]*z^2 + ... + p1[n1]*z^n1
	// pdest[0] to pdest[n1+n2] (n1+n2)th degree polynomial
