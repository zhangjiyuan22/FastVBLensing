...
#include"VBMicrolensing_lib_no_optimization/VBMicrolensingLibrary.h"
...
int main(int argc, char *argv[]) 
{
    ...
    */
    ...
    // original version
    char file_name[] = "../result/test_VBMicrolensing_result_no_optimization_1_with_RelTol_1eminus4.txt" ;
    file_name[53] = file_number ;
