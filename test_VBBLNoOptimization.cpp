...
#include <math.h>
#include <chrono>
#include"VBBL_lib_no_optimization/VBBinaryLensingLibrary_v3p6.h"
...
int main(int argc, char *argv[]) 
{
    ...
    char file_name[] = "../result/test_VBBL_result_no_optimization_1_with_RelTol_1eminus4.txt" ;
    file_name[43] = file_number ;
